...
const TASK_TYPE_OWNER_MAP = {
  ...
  [TASK_TYPE.GAMEPLAY_BEATS_GENERATE]: 'tests/unit/worker/story-to-script.test.ts',
  [TASK_TYPE.GAMEPLAY_KEYFRAME_GENERATE]: 'tests/unit/worker/image-worker.test.ts',
  [TASK_TYPE.GAMEPLAY_SHOT_GENERATE]: 'tests/unit/worker/video-worker.test.ts',
  [TASK_TYPE.GAMEPLAY_UI_COMPOSE]: 'tests/unit/worker/story-to-script.test.ts',
  [TASK_TYPE.GAMEPLAY_VOICEOVER_GENERATE]: 'tests/unit/worker/voice-worker.test.ts',
  [TASK_TYPE.GAMEPLAY_RENDER]: 'tests/unit/worker/video-worker.test.ts',
